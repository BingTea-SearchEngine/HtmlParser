...
class HtmlTag {
   public:
    ...
    HtmlTag(std::string tag, const DesiredAction action)
        : Tag(std::move(tag)), Action(action) {}
};
...
const HtmlTag TagsRecognized[] = {{"!--", DesiredAction::Comment},
                                  ...
                                  {"h1", DesiredAction::Emphasize},
                                  {"h2", DesiredAction::Emphasize},
                                  {"h3", DesiredAction::Emphasize},
